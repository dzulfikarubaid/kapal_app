...
const FmFpr = () => {
    ...
    useEffect(() => {
        ...
        if (filteredData.length > 0) {
            ...
            setPrice1Type(item.price1type)
            setPrice2Type(item.price2type)
            setPrice3Type(item.price3type)
            setPrice1Value(item.price1value)
            setPrice2Value(item.price2value)
            setPrice3Value(item.price3value)
        }
    }, [vn, vc, route, data])
